        ...
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
          ...
          <Box>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mt: 0.5 }}>
              {activeCount} {t('financialGoals.heroOverview.activeGoals')}
            </Typography>
          </Box>
        </Box>
        ...
        >
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="body2" color="text.secondary">
              {t('financialGoals.heroOverview.totalTarget')}
            </Typography>
          </Box>
          ...
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="body2" color="text.secondary">
              {t('financialGoals.heroOverview.totalSaved')}
            </Typography>
          </Box>
          ...
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="body2" color="text.secondary">
              {t('financialGoals.heroOverview.estimatedCompletion')}
            </Typography>
          </Box>
        </Box>
